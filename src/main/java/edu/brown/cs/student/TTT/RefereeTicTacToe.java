...
/**
 * Referee class for TicTacToe.
 */
public class RefereeTicTacToe implements Referee {
  ...
  private void gameLoop(Game<Integer[], Integer> game,
                        Player<Game<Integer[], Integer>, Integer[], Integer> p1,
                        Player<Game<Integer[], Integer>, Integer[], Integer> p2) {
    boolean stop = false;
  ...
  public void startGame(String[] splitUserInput) {
    Game<Integer[], Integer> game = new TicTacToe();
    Player<Game<Integer[], Integer>, Integer[], Integer> p1;
    Player<Game<Integer[], Integer>, Integer[], Integer> p2;
    boolean p1AI = false;
